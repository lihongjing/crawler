	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleClick(e) {
	      e.preventDefault();
	      console.log('client');
	      _jquery2.default.post('/', { 'url': 'http://www.apia.com.au' }, function (data) {
	        console.log('client');
	        console.log(data);
	      });
	      // this.setState({
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          null,
	          _react2.default.createElement('input', { type: 'text', ref: 'domain' }),
	          _react2.default.createElement('input', { type: 'submit', value: 'Start', onClick: this.handleClick })
	        )
	      );
	    }
	  }]);
